...
class Mod {
    ...
    postDBLoad(container) {
        ...
        if (!config_json_1.default?.Enabled || !config_json_2.default.scavRework) {
            return;
        }
        ...
        for (let [key, value] of Object.entries(config_json_1.default)) {
    ...
    generate(sessionID) {
        return new PlayerBossScav_1.PlayerBossScav(Mod.container.resolve("WinstonLogger"), Mod.container.resolve("DatabaseServer"), Mod.container.resolve("SaveServer"), Mod.container.resolve("ProfileHelper"), Mod.container.resolve("BotHelper"), Mod.container.resolve("JsonUtil"), Mod.container.resolve("FenceService"), Mod.container.resolve("BotLootCacheService"), Mod.container.resolve("BotGenerator"), Mod.container.resolve("ConfigServer")).generatePlayerScav(sessionID, Mod.container);
    }
}
